...
class _SettingsViewState extends State<SettingsView> {
  ...
  _onSelectMenu(String action) async {
    switch(action) {
      case act.Actions.RESET_ODOMETER:
        bg.BackgroundGeolocation.setOdometer(0.0);
        break;
      case act.Actions.SYNC:
        act.Actions.sync(context);
        break;
      case act.Actions.DESTROY_LOCATIONS:
        act.Actions.destroyLocations(context);
        break;
      case act.Actions.EMAIL_LOG:
        act.Actions.emailLog(context);
        break;
      case act.Actions.DESTROY_LOG:
        act.Actions.destroyLog(context);
        break;
      case act.Actions.REMOVE_GEOFENCES:
        ...
        actions: [
          new PopupMenuButton(
              itemBuilder: (_) => <PopupMenuEntry<String>>[
                const PopupMenuItem<String>(value: act.Actions.RESET_ODOMETER, child: ListTile(title: Text('Reset odometer'), leading: Icon(Icons.av_timer))),
                const PopupMenuItem<String>(value: act.Actions.SYNC, child: ListTile(title: Text('Sync'), leading: Icon(Icons.cloud_upload))),
                const PopupMenuItem<String>(value: act.Actions.DESTROY_LOCATIONS, child: ListTile(title: Text('Destroy locations'), leading: Icon(Icons.delete))),
                const PopupMenuDivider(),
                const PopupMenuItem<String>(value: act.Actions.EMAIL_LOG, child: ListTile(title: Text('Email log'), leading: Icon(Icons.email))),
                const PopupMenuItem<String>(value: act.Actions.DESTROY_LOG, child: ListTile(title: Text('Destroy log'), leading: Icon(Icons.delete))),
                const PopupMenuDivider(),
                const PopupMenuItem<String>(value: act.Actions.REMOVE_GEOFENCES, child: ListTile(title: Text('Remove geofences'), leading: Icon(Icons.delete))),
                const PopupMenuDivider(),
